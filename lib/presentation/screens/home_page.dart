                  ...
                  Row(
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            'Hi, ${userState.loginUser!.fullName}!',
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              GestureDetector(
                                onTap: () {
                                  final tripId = topRateTrips[0].tripId;
                                  context.goNamed(
                                    'trip_detail',
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              GestureDetector(
                                onTap: () {
                                  final tripId = topRateTrips[1].tripId;
                                  context.goNamed(
                                    'trip_detail',
                                    pathParameters: {'id': tripId.toString()},
                                  );
                          ...
                          children: [
                            ...
                            AppButton(
                              ...
                              onTap: () {
                                ...
                                ref
                                        .read(
                                          tripSortAscendingProvider.notifier,
                                        )
                                        .state =
                                    false;
                                ref
                          ...
                          children: List.generate(5, (index) {
                            return Column(
                              children: [
                                GestureDetector(
                                  onTap: () {
                                    final tripId = popularTrips[index].tripId;
                                    context.goNamed(
                                      'trip_detail',
                                      pathParameters: {'id': tripId.toString()},
                                    );
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return GestureDetector(
                          onTap: () {
                            // print('from home: ${trips[index].tripId}');
                            context.goNamed(
                              'trip_detail',
                              pathParameters: {'id': trips[index].tripId},
                            );
                          },
                          child: TripCard(
